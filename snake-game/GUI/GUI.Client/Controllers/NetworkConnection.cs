...
public sealed class NetworkConnection : IDisposable
{
    ...
    public async Task ConnectConnectionAsync( string host, int port )
    {
        // connect
    ...
    public async Task WriteAsync( string message )
    {
        ...
        // async write message to server
        await _writer.WriteLineAsync(message);
    }
    
    /// <summary>
    /// Write method to send a message on a networkconnection
    /// </summary>
    ...
    public async Task<string> ReadLineAsync( )
    {
        ...
        // async read server message
        return await _reader!.ReadLineAsync() ?? throw new InvalidOperationException( );
    }
    
    /// <summary>
    /// read a message from the remote side of the connection
    /// </summary>
    ...
    {
        // close the connection and dispose streams
        _tcpClient.Close();
        _reader?.Dispose();
        _writer?.Dispose();
    }
